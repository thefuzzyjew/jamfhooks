...
class JSSServer(models.Model):
    JSSSTATUS = (("JSSStartup", "JSSStartup"), ("JSSShutdown", "JSSShutdown"))
    name = models.CharField(max_length=25)
            ...
            if snipeit_comp_data["total"] == 0:
                ...
                try:
                    ...
                    if jss_asset_response.status_code != 200:
                        ...
                        response_code = "Response code: " + str(
                        ...
                        jss_computer_name = jss_asset_result["computer"]["general"][
                            "name"
                        ]
                        jss_asset_tag = jss_asset_result["computer"]["general"][
                            "asset_tag"
                        ]
                        jss_user_name = jss_asset_result["computer"]["location"][
                            "username"
                        ]
                        jss_real_name = jss_asset_result["computer"]["location"][
                            "real_name"
                        ]
                        ...
                        if jss_asset_tag == "":
                            ...
                            snipeit_model_response = requests.get(
                                snipe_model_url,
                            ...
                            if snipeit_model_response.status_code != 200:
                                ...
                                if snipeit_model_data["rows"][0]["name"] != jss_model:
                                    ...
                                    snipe_create_asset[
                                        ...
                                        1
                                    )  # 1=Ready to Deploy. This will be the default unil device is checked out
                                    ...
                                    snipe_create_asset_url = (
                                        self.url + "/api/v1/hardware/"
                                    )
                                    snipeit_create_asset_response = requests.post(
                                        snipe_create_asset_url,
                                        headers=snipe_headers,
                                        json=snipe_create_asset,
                                    )
                                    snipeit_create_asset_data = (
                                        snipeit_create_asset_response.json()
                                    )
                ...
                try:
                    ...
                    if jss_asset_response.status_code != 200:
                        ...
                        status = snipeit_comp_data["rows"][0]["status_label"][
                            "status_meta"
                        ]
                        ...
                        if computer_name == jss_computer_name:
                            ...
                            snipeit_name_response = requests.put(
                                snipe_name_url,
                                json=snipe_patch_payload,
                                headers=snipe_headers,
                            )
